        ...
        <section className="relative overflow-hidden">
            ...
            <div className="relative max-w-5xl mx-auto px-5 sm:px-8 pb-0">
                <div className="rounded-t-2xl overflow-hidden border border-gray-200 border-b-0">
                    {/* Browser chrome */}
                    <div className="flex items-center gap-2 px-4 py-3 hero-browser-chrome">
                    ...
                    {/* Mock content */}
                    <div className="p-6 hero-mock-content">
                        {/* Stat row */}
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
                            {[
                                ...
                                <div key={s.label} className="rounded-xl p-4 bg-white hero-stat-card">
                        ...
                        {/* Activity list */}
                        <div className="rounded-xl p-4 space-y-3 bg-white hero-activity-list">
